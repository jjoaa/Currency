...
namespace currency.ViewModels
{
    public partial class MainViewModel : ObservableObject
    {
        ...
        private RelayCommand _loadRatesCommand;
        public ICommand LoadRatesCommand => _loadRatesCommand;
        ...
        public bool IsLoading
        {
            ...
            set
            {
                ...
                _loadRatesCommand.RaiseCanExecuteChanged();
            }
        }

        public MainViewModel()
        {
            _loadRatesCommand = new RelayCommand(LoadRatesAsync, () => !IsLoading);
            _ = LoadRatesAsync();
        }
